...
There is a FLOSS interface for the ROCK, iROCK, available at https://sci-ops.gitlab.io/irock/ (the accompanying git repository is available at https://gitlab.com/sci-ops/irock).
