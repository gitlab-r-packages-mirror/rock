...
If all children of a code are so-called 'leaves' (i.e. in the coding tree, they have no children of their own^[This is less sad than it may look; children are, among other things, very bad for the environment.]), they can be specified more efficiently:
