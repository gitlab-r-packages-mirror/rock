...
In the ROCK, the identifiers, such as case identifiers, can be used, but section identifiers can also be used to specify units.
...
$$\text{codes} = {\text{units} \choose 2} + 1$$

This means that if you have 


Is a code a coded fragment? Or is a code a `code`?
