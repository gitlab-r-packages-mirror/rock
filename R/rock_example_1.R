#' Example 1
#'
rock_example_1 <- unlist(strsplit("
---
metadata:
  -
    caseId: 1
...
Text taken from https://www.lipsum.com/.
...
specimen book. [[parentCode1>childCode2]]

It has survived not only five centuries, but also the leap into
electronic typesetting, remaining essentially unchanged. [[parentCode1>childCode3]]

It was popularised in
the 1960s with the release of Letraset sheets containing Lorem Ipsum passages,
and more recently with desktop publishing software like Aldus PageMaker
including versions of Lorem Ipsum. [[parentCode2>childCode1]]
...
content of a page when looking at its layout. [[parentCode2>childCode2]]
...
Where does it come from? [[parentCode2>childCode1>grandchildCode1]]

Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots
in a piece of classical Latin literature from 45 BC, making it over 2000 years
old.  [[parentCode2>childCode1>grandchildCode2]]

Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia,
looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum
passage, and going through the cites of the word in classical literature,
discovered the undoubtable source. [[parentCode2>childCode1>grandchildCode2]]
